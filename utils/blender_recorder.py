...
class PyBulletRecorder:
    class LinkTracker:
        ...
        def convert_quat(self, quat):
            quat = torch.as_tensor(quat)[[3,0,1,2]]
            cvt_quat = pk.standardize_quaternion(quat)[[1,2,3,0]].numpy()
            return cvt_quat
        ...
        def get_keyframe(self):
            if self.link_id == -1:
                ...
                orientation = self.convert_quat(orientation)
            return {
