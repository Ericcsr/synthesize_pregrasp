...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--latent_size', type=int, default=3)
        self.parser.add_argument(
            '--gripper_pc_npoints',
            type=int,
            default=-1,
        ...
        self.parser.add_argument(
            '--num_input_pointcloud_points',
            help=
            'Number of points in the input point cloud. Defaults to model_param.num_points_in_input_point_cloud',
            type=int,
            default=model_param.final_num_points_in_input_point_cloud
        )
        self.parser.add_argument(
            '--pc_noise_variance',
            type=float,
            default=0.,
            help='Variance of the Gaussian noise added to the point cloud points'
        )
    ...
    def parse(self):
        ...
        self.opt.base_pose_weight = (1e3,1e3,1e3,1.,1.,1.,1.) # Weighting on base pose loss (vs finger angle, which has weight 1)
