...
class NPGraspNet(nn.Module):
    def __init__(self, opt=None, pred_fingers=[0,1,2], extra_cond_fingers=[], device="cuda:0"):
        ...
        self.dex_grasp_net = DexGraspNetModel(opt, pred_base=False, 
                                              pred_fingers=self.num_pred_fingers,
    ...
    def load_dex_grasp_net(self, model_path):
        self.dex_grasp_net.load_network_test(model_path)
