...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--use_wandb',
                                 ...
                                 default=True)
        self.parser.add_argument('--override_saved',
                                 action='store_true',
                                 help='Override saved directory if there is one',
                                 default=False)
        self.parser.add_argument('--test_ratio',
                                 type=float,
                                 default=0.01,
                                 help='% of data to use as test set. The rest are used as training.')
        self.parser.add_argument('--grasp_perturb_copies',
                                 type=int,
                                 default=3,
                                 help='How many perturbed (on x, y, yaw) copies for each grasp')
        self.is_train = True
